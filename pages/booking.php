...
<!--		<div class="pre-loader">
					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li><a href="booking.php" class="active">All Book</a></li>
		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
			    <div class="row">
			        ...
			        <div class="col-lg-10">
			            <a href="javascript:void(0);" class="btn btn-outline-primary" onclick="exportf(this)"><span class="bi bi-download"></span> Export Reservation</a>
			        </div>
			    </div>
			    <br/>
				<div class="card-box">
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											...
											<div class="modal-body row">
											    <div class="col-12">
											        <button type="button" class="btn btn-primary btn-sm" style="float:right;" id="print" onclick="Print()"><span class="bi bi-printer"></span> PRINT</button>
											    </div>
		...
		function Print() 
		{
            ...
            mywindow.document.write('<link rel="stylesheet" type="text/css" href="vendors/styles/core.css" />');
            mywindow.document.write('<link rel="stylesheet" type="text/css" href="src/plugins/datatables/css/dataTables.bootstrap4.min.css"/>');
            mywindow.document.write('<link rel="stylesheet" type="text/css" href="src/plugins/datatables/css/responsive.bootstrap4.min.css"/>');
            mywindow.document.write('<link rel="stylesheet" type="text/css" href="vendors/styles/style.css" />');
            mywindow.document.write('</head><body >'); 
            mywindow.document.write(document.getElementById("output").innerHTML);
		    ...
		    {
		        var ask = confirm("Do you want to remove this reservation?");
		        if(ask)
		        {
		            var action ="reject";
		            var val = $(this).val();
		    ...
		    {
		        var ask = confirm("Do you want to accept this reservation?");
		        if(ask)
		        {
		            var val = $(this).val();
		            $('#code').attr("value",val);
		    ...
		    {
		        var ask = confirm("Do you want to set as done this reservation?");
		        if(ask)
		        {
		            var action ="complete";
		            var val = $(this).val();
		    ...
		    {
		        var ask = confirm("Do you want to cancel this reservation?");
		        if(ask)
		        {
		            var action ="cancel";
		            var val = $(this).val();
		    ...
		    $('#search').keyup(function()
		    {
		        var action = "search";
		        var val = $(this).val();
		        $('#tbltransaction').html("<tr><td colspan='9'><center>Searching...</center></td></tr>");
		        $.ajax({
		            url:"../resources/book.php",method:"POST",
		            ...
		            success:function(data)
		            {
		                if(data==="")
		                {
		                    $('#tbltransaction').html("<tr><td colspan='9'><center>No Reservation</center></td></tr>");
		                }
		                else
		                {
		    ...
		    $('#filter').change(function()
		    {
		       var val = $(this).val();
		       var action = "filter";
		       $('#tbltransaction').html("<tr><td colspan='9'><center>Loading...</center></td></tr>");
		        $.ajax({
		            url:"../resources/book.php",method:"POST",
		            data:{action:action,filter:val},
		            success:function(data)
		            {
		                if(data==="")
		                {
		    ...
		    function exportf(elem) {
              ...
              elem.setAttribute("download","reservation.xls"); // Choose the file name
              return false;
            }
		</script>
	</body>
