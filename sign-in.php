<?php
    ...
    if(isset($_POST['btnLogin']))
    {
        try
        {
            ...
            $stmt = $dbh->prepare("Select Fullname,customerID from tblcustomer WHERE EmailAddress=:username AND Password=SHA1(:password) AND Status=1");
