...
<html>
	...
	<body>
		...
		<script>
		    ...
		    {
		        $('#tblreservation').html("<tr><td colspan='6'><center>Searching...</center></td></tr>");
		        var action = "search";
		        var text = $(this).val();
		        var user = <?php echo $_SESSION['sess_id'] ?>;
		        $.ajax({
		            url:"../resources/customer.php",method:"GET",
		            data:{action:action,user:user,keyword:text},
		            success:function(data)
		            {
		                if(data==="")
		                {
		                    $('#tblreservation').html("<tr><td colspan='6'><center>No Data</center></td></tr>");
		                }
		                else
		                {
		                    $('#tblreservation').html(data);
		                }
		            }
		        });
		    });
		    function load()
		    {
		        $('#tblreservation').html("<tr><td colspan='6'><center>Loading...</center></td></tr>");
