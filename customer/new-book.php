...
<html>
    ...
    try
    {
        ...
        if(isset($_POST['btnSave']))
        {
            ...
            $client_name = $_SESSION['sess_fullname'];
            $phone;$email;$address;
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							<a href="new-book.php" class="dropdown-toggle no-arrow">
				            ...
				            <div class="card-body">
				                ...
				                <div class="row">
				                    ...
				                    <div class="col-12">
				                        ...
				                        <textarea name="event_location" class="form-control" style="height:150px;" required></textarea>
				                    </div>
				                    <div class="col-12">
				                        <div class="row">
				                            <div class="col-6">
				        ...
				        <div class="card-box" id="package_menu">
				            <div class="card-body">
				                ...
				                <div class="row">
				                    ...
				                    <div class="col-12">
				                        <br/>
				                        <input type="checkbox" required/>By ticking the box, you are confirming that you have read, understood and agreed to Zephaniah's Event and Catering Services <a href="ZEPHANIAHS-NEW-CONTRACT-AGREEMENT.pdf">terms and conditions.</a>
				                    </div>
				                    <div class="col-12">
				                        <br/>
				                        <input type="submit" class="form-control btn btn-primary" name="btnSave" value="Book"/>
				                    </div>
				                </div>
				            </div>    
				        </div>
