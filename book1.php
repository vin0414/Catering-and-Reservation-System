...
?>
	...
	<body>
	    <?php
	    if(empty($_SESSION['sess_fullname']))
	    {
	    ?>
    		<div class="container">
	        ...
	        <div class="container">
    		    ...
    		    <div style="float:right;margin-top:10px;">
					<div class="dropdown">
						...
						>
						    <a class="dropdown-item" href="customer/reservation.php"
								><i class="dw dw-calendar"></i> Reservation</a
							>
				            ...
				            <div class="card-body">
				                ...
				                <div class="row">
				                    <div class="col-12">
				                        ...
				                        <input type="text" class="form-control" name="client_name" value="<?php if(empty($_SESSION['sess_fullname'])) echo "";else {echo $_SESSION['sess_fullname']; }  ?>" required/>
				                    </div>
				                    <?php if(empty($_SESSION['sess_fullname']))
				                    {
				                    ?>
				                    <div class="col-12">
				                        <div class="row">
				                            <div class="col-lg-6">
				                                <label>Contact #</label>
				                                <input type="tel" pattern="+[0-9]{10}" placeholder="+63XXXXXXXXXX" class="form-control" name="phone" maxlength="13" required/>
				                            </div>
				                            <div class="col-lg-6">
				                    ...
				                    {
				                        $stmt = $dbh->prepare("Select * from tblcustomer WHERE Status=1 AND customerID=:id");
				                        $stmt->bindParam(':id',$_SESSION['sess_id']);
				                        $stmt->execute();
				                        ...
				                        foreach($customer as $row)
				                        {
				                            ...
				                            <div class="col-12">
        				                        <div class="row">
        				                            <div class="col-lg-6">
        				                                <label>Contact #</label>
        				                                <input type="phone" class="form-control" name="phone" value="<?php echo $row['Contact'] ?>" maxlength="11" required/>
        				                            </div>
        				                            <div class="col-lg-6">
        				                                <label>Email Address</label>
        				                    ...
        				                    <div class="col-12">
        				                        <label>Complete Address</label>
        				                        <textarea class="form-control" name="address" style="height:100px;" required><?php echo $row['Address'] ?></textarea>
        				                    </div>
				                            <?php
				                        }
				                    }
